...
> **CRITICAL INSTRUCTION:** When you adopt a role (e.g., Planner, Developer), you **MUST** first read the corresponding definition file in `.claude/agents/workflow-<role>.md` — it is the sole source of truth for that role's Entry, Responsibilities, Output Format, Behavioral Rules, and Exit. You are strictly bound by it.
