---
trigger: glob
globs: "**/*Tests*/**, **/tests/**, **/__tests__/**, **/*.test.ts, **/*.test.tsx, **/*.spec.ts, **/*.spec.tsx, **/*.test.js, **/*.test.jsx, **/*.spec.js, **/*.spec.jsx, **/test_*.py, **/*_test.py, **/tests/**/*.py, **/*.Tests.cs, **/*Tests.cs"
---
...
For activated frontend scopes, use `../skills/web-frontend-development/SKILL.md`.

For activated Node.js scopes, use `../skills/node-development/SKILL.md`.

For activated Python scopes, use `../skills/python-development/SKILL.md`.
