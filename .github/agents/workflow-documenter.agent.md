...
handoffs:
  - label: Send approved RFC to Developer for implementation
    ...
    prompt: Implement the solution based on this approved RFC.
    send: true
  - label: Send Design Doc to Developer for implementation
    agent: workflow-developer
    prompt: Implement against this Design Doc. It carries the components, APIs, data flow and edge cases; the linked ADRs carry the why.
    send: true
---
